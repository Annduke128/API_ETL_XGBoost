...
## 🗑️ Bảng đã xóa (Không cần thiết)

| Bảng | Lý do xóa | Ngày xóa |
|------|-----------|----------|
| `fact_transactions` | Legacy từ CSV pipeline, không dùng trong DBT | 2026-02-21 |
| `staging_transaction_details` | Trùng lặp với `stg_transaction_details` (DBT view) | 2026-02-21 |
